...
// function prompts user actions to be taken
function prompt() {
  inquirer
    .prompt({
      name: "action",
...
async function removeEmployee() {
  const answer = await inquirer.prompt([
    {
      name: "first",
      type: "input",
      message: "Enter the employee ID you want remove:  ",
    },
  ]);
  ...
  console.log("Employee removed on the system!");
  prompt();
}
